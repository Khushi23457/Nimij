...
const {getUserOrders,placeOrder,cancelOrder,showPaymentSelection,placeOrderOnline,verifyPayment}=require('../controllers/orderController')
...
router.post('/place-order/:addressid', isLoggedIn, placeOrder);
router.post('/placeorderOnline/:addressid', isLoggedIn, placeOrderOnline);
...
router.get("/selectpayment/:addressid", isLoggedIn, showPaymentSelection);
